...
export interface Person extends Partner { 
    /**
     * Partner AVS Number
     */
    avsNumber?: number;
     ...
     */
    civilStatus?: Person.CivilStatusEnum;
    /**
...
export namespace Person {
    export type CivilStatusEnum = 'single' | 'married' | 'divorced' | 'widower' | 'separate';
    export const CivilStatusEnum = {
        Single: 'single' as CivilStatusEnum,
        Married: 'married' as CivilStatusEnum,
        Divorced: 'divorced' as CivilStatusEnum,
        Widower: 'widower' as CivilStatusEnum,
        Separate: 'separate' as CivilStatusEnum
    };
